...
void ::Join__NBA::GroupDetailPage::InitializeComponent()
{
    if (_contentLoaded)
        return;
...
void ::Join__NBA::GroupDetailPage::Connect(int connectionId, Platform::Object^ target)
{
    switch (connectionId)
    {
    case 1:
        (safe_cast<::Windows::UI::Xaml::Controls::ListViewBase^>(target))->ItemClick +=
            ref new ::Windows::UI::Xaml::Controls::ItemClickEventHandler(this, (void (::Join__NBA::GroupDetailPage::*)(Platform::Object^, Windows::UI::Xaml::Controls::ItemClickEventArgs^))&GroupDetailPage::ItemView_ItemClick);
        break;
    case 2:
        (safe_cast<::Windows::UI::Xaml::Controls::ListViewBase^>(target))->ItemClick +=
            ref new ::Windows::UI::Xaml::Controls::ItemClickEventHandler(this, (void (::Join__NBA::GroupDetailPage::*)(Platform::Object^, Windows::UI::Xaml::Controls::ItemClickEventArgs^))&GroupDetailPage::ItemView_ItemClick);
    ...
    case 3:
        (safe_cast<::Windows::UI::Xaml::Controls::Primitives::ButtonBase^>(target))->Click +=
            ref new ::Windows::UI::Xaml::RoutedEventHandler(this, (void (::Join__NBA::GroupDetailPage::*)(Platform::Object^, Windows::UI::Xaml::RoutedEventArgs^))&GroupDetailPage::GoBack);
        break;
    }
